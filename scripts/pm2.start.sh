...
pm2 start /usr/bin/etcd --name etcd-1 --namespace tsunami -- --config-file /etc/tsunami/conf/etcd-1.config.yaml
pm2 start /usr/bin/etcd --name etcd-2 --namespace tsunami -- --config-file /etc/tsunami/conf/etcd-2.config.yaml
pm2 start /usr/bin/etcd --name etcd-2 --namespace tsunami -- --config-file /etc/tsunami/conf/etcd-2.config.yaml
